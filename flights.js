            ...
            <tr>
                ...
                <td>
                  <div style="display: inline-flex; gap: 8px; align-items: center;">
                    ...
                    <button class="btn btn-sm" onclick="viewFlight('${flight.flightNumber}')"      style="padding: 4px 10px; font-size: 0.75rem; border-radius: 4px; background-color: #007bff; color: white; border: none; cursor: pointer;">
View</button>
                    <button class="btn btn-sm" onclick="editFlight('${flight.flightNumber}')"  style="padding: 4px 10px; font-size: 0.75rem; border-radius: 4px; background-color: #6c757d; color: white; border: none; cursor: pointer;">Edit</button>
                  </div>
